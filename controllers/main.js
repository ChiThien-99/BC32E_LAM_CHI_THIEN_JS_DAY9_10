...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  //---------- Kiểm Tra Rỗng --------------
  valid &=
    kiemTraRong(nv.taiKhoang, "#error_required_tknv", "Tài Khoảng") &
    kiemTraRong(nv.hoTen, "#error_required_name", "Họ Tên") &
    kiemTraRong(nv.email, "#error_required_email", "Email") &
    kiemTraRong(nv.matKhau, "#error_required_pass", "Mật Khẩu") &
    kiemTraRong(nv.ngayLam, "#error_required_date", "Ngày Làm") &
    kiemTraRong(nv.luongCoBan, "#error_required_luongCB", "Lương cơ bản") &
  ...
  // ----------- kiểm tra định dạng -----------
  valid &=
    kiemTraTatCaKyTu(nv.hoTen, "#error_checkName", "Họ Tên") &
    kiemTraEmail(nv.email, "#error_checkEmail", "Email") &
    kiemTraMatKhau(nv.matKhau, "#error_checkPass1", "Mật Khẩu");
    ...
    html += `
            <tr>
                ...
                <td>
                    ...
                    data-target="#myModal" class="btn btn-success"  onclick="chinhSua('${
                      nv.taiKhoang
                    }')">Chỉnh sửa</button>
                </td>
            </tr>
...
function xoaNhanVien(taiKhoangClick) {
  var indexDel = mangNhanVien.findIndex(
    (NhanVien) => NhanVien.taiKhoang === taiKhoangClick
  );
  if (indexDel !== -1) {
...
function chinhSua(taiKhoangClick) {
  ...
  var indexEdit = mangNhanVien.findIndex(
    (nv) => nv.taiKhoang === taiKhoangClick
  );
...
document.querySelector("#btnCapNhat").onclick = function () {
  ...
  var indexEdit = mangNhanVien.findIndex(
    (NhanVien) => NhanVien.taiKhoang === nv.taiKhoang
  );
